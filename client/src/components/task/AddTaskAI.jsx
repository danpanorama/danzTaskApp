...
async function fetchTaskFromAI(freeText) {
  const response = await fetch("https://api.openai.com/v1/chat/completions", {
    ...
    headers: {
      ...
      Authorization: `Bearer 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`, // החלף למפתח שלך
    },
    body: JSON.stringify({
      model: "gpt-3.5-turbo",
      messages: [
